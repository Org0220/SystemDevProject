...
<body background="Wallpaper.png" style= "background-repeat: no-repeat; background-size: cover;">
    ...
    <form style="font-family: 'Open Sans', sans-serif;">        
        ...
        <div class="d-flex justify-content-center">
            <button type="submit" name="login" class="btn btn-primary" style="height: 50px; width: 50%; border: none; outline: none; border-radius: 60px; font-weight: 600; background: #EFE5FF; color:#CFB0D5;">Login</button>
        </div><br><br>
